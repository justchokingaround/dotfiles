...
server_choice=$(curl -s -H "Authorization: $token" "https://discord.com/api/v9/users/@me/guilds"|tr "{|}" "\n"|
...
channel=$(curl -s -H "Authorization: $token" "https://discord.com/api/v9/guilds/${server_id}/channels"|tr "{|}" "\n"|
